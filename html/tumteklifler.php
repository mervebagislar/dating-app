            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="tumTeklifTable" class="table table-bordered table-striped dataTable dtr-inline collapsed" aria-describedby="tumTeklifTable_info">
                                    <thead>
                                        <tr>
                                            <th>İşlemler</th>
                                            <th>Durumu</th>
