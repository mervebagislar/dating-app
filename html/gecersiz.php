...
<head>
    ...
    <title>Geçersiz Teklifler</title>   
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="gecersizTeklifTable" class="table table-bordered table-striped dataTable dtr-inline collapsed" aria-describedby="gecersizTeklifTable_info">
                                    <thead>
                                        <tr>
                                            <th>İşlemler</th>
                                            <th>Teklif Adı</th>
